...
/**
 * Public no-auth mock of application-shell1 chrome.
 * Forces light theme while mounted for block comparison; restores prior preference on leave.
 */
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 p-4 md:gap-6 md:p-6">
        <div className="grid grid-cols-1 gap-4 @xl/main:grid-cols-2 @5xl/main:grid-cols-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <p className="text-sm text-muted-foreground">
          application-shell1 chrome — VesperWise routes, credits strip, Clerk-shaped user
          menu. Compare with{" "}
          <span className="font-medium text-foreground">shadcnblocks application-shell1</span>.
        </p>
      </div>
    </ApplicationShell1>
  );
